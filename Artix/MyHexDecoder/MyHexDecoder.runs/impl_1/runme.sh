...
HD_PWD='C:/Users/patri/OneDrive/Documentos/Creditos/VHDL/Artix/MyHexDecoder/MyHexDecoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MyHexDecoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MyHexDecoder.tcl -notrace
