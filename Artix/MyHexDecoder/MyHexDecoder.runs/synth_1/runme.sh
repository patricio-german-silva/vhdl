...
HD_PWD='C:/Users/patri/OneDrive/Documentos/Creditos/VHDL/Artix/MyHexDecoder/MyHexDecoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MyHexDecoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MyHexDecoder.tcl
