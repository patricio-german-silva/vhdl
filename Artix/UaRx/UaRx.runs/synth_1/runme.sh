...
HD_PWD='C:/Users/patri/OneDrive/Documentos/vhdl/Artix/UaRx/UaRx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UaRx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UaRx.tcl
