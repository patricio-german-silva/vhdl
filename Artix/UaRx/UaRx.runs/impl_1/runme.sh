...
HD_PWD='C:/Users/patri/OneDrive/Documentos/vhdl/Artix/UaRx/UaRx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UaRx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UaRx.tcl -notrace
