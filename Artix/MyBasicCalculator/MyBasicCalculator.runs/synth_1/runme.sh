...
HD_PWD='C:/Users/patri/OneDrive/Documentos/Creditos/VHDL/Artix/MyBasicCalculator/MyBasicCalculator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MyBasicCalculator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MyBasicCalculator.tcl
