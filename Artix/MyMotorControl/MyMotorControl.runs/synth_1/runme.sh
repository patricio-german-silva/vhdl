...
HD_PWD='C:/Users/patri/OneDrive/Documentos/Creditos/VHDL/Artix/MyMotorControl/MyMotorControl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MyMotorControl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MyMotorControl.tcl
