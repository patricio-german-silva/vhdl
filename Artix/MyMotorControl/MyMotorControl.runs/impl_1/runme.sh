...
HD_PWD='C:/Users/patri/OneDrive/Documentos/Creditos/VHDL/Artix/MyMotorControl/MyMotorControl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MyMotorControl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MyMotorControl.tcl -notrace
