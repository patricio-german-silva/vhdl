...
HD_PWD='C:/Users/patri/OneDrive/Documentos/vhdl/Integrador/Artix/IMain/IMain.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IMain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IMain.tcl
