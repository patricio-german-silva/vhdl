...
HD_PWD='C:/Users/patri/OneDrive/Documentos/vhdl/Integrador/Artix/IMain/IMain.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IMain.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IMain.tcl -notrace
